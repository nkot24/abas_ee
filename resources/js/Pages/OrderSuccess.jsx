        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center px-6" style={{ fontFamily: "'Segoe UI', sans-serif" }}>
            <div className="text-center max-w-md">
                ...
                <h1 className="text-3xl font-black text-gray-900 mb-2">
                    {paid ? t.orderSuccess.title : (t.orderSuccess.pendingTitle ?? 'Apdorojama...')}
                </h1>
                ...
                <p className="text-gray-400 text-sm mt-4 mb-8">
                    {paid
                        ? <>{t.orderSuccess.confirmSent} <strong>{order.email}</strong>.</>
                        : (t.orderSuccess.pendingNote ?? 'Mokėjimas apdorojamas. Patvirtinimas bus išsiųstas el. paštu.')}
                </p>
