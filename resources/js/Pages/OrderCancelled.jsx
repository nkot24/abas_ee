    ...
    return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center px-6" style={{ fontFamily: "'Segoe UI', sans-serif" }}>
            <div className="text-center max-w-md">
                ...
                <h1 className="text-3xl font-black text-gray-900 mb-3">Mokėjimas atšauktas</h1>
                <p className="text-gray-500 mb-8">Užsakymas nebuvo apmokėtas. Galite bandyti dar kartą.</p>
