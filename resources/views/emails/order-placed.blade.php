      ...
      <table width="580" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:4px;overflow:hidden;">
        ...
        <tr>
          <td style="padding:36px 40px 8px;">
            ...
            <h1 style="margin:0;font-size:26px;font-weight:700;color:#1a1a1a;">Naujas užsakymas gautas!</h1>
          </td>
        </tr>
        <tr>
          <td style="padding:12px 40px 28px;">
            <p style="margin:0;font-size:15px;color:#555;line-height:1.6;">Apmokėjimas patvirtintas. Žemiau rasite užsakymo detales.</p>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:32px 40px;border-top:1px solid #e8e8e8;margin-top:28px;">
            <p style="margin:0;font-size:13px;color:#999;text-align:center;">ABAS Home Smokehouse administracija</p>
          </td>
        </tr>
